...
@student_bp.patch('/update-student-info')
@login_required
def update_student_info():
    try:
        ...
        if 'grade' in request.form:
            student_information.grade = request.form['grade']
        ...
        if 'avatar' in request.files:
            ...
            # 删除旧头像（如果存在且不是默认头像）
            if student.avatar and not student.avatar.endswith('default_avatar.jpg'):
                old_avatar_path = student.avatar
